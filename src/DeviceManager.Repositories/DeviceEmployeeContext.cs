...
public partial class DeviceEmployeeContext : DbContext
{
    public DeviceEmployeeContext()
    {
    }
    public DeviceEmployeeContext(DbContextOptions<DeviceEmployeeContext> options)
        : base(options)
    {
    }
